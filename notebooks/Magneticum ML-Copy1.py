...
np.savez(data_dir / 'chandra_training_data_and_folds',logo_iter=logo_iter, train=train, train_labels=train_labels)
...
plt.text(13.6,14.7,r'$\delta_\mathrm{RF} = %.4f$' % rf_scatter_robust, fontsize=18)
plt.text(13.6,14.6,r'$\mu_\mathrm{RF} = %.4f$' % robust_bias, fontsize=18)
plt.text(13.6,14.5,r'$A = %.2f$' % lin_reg.coef_[0], fontsize=18)
plt.text(13.6,14.4,r'$B = %.2f$' % lin_reg.intercept_, fontsize=18)
